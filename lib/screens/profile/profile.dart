                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          decoration:
                              BoxDecoration(color: primaryBackgroundColor),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border:
                                    Border.all(color: primaryBackgroundColor)),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: TextFormField(
                                readOnly: true,
                                initialValue: value.map["user"]["email"],
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: TextFormField(
                                initialValue: value.map["user"]["name"],
                                onSaved: (value) => name = value,
                                onChanged: (value) => name = value,
                                decoration: InputDecoration(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: TextFormField(
                                initialValue: value.map["user"]["factory_name"],
                                onSaved: (value) => factoryName = value,
                                onChanged: (value) => factoryName = value,
                                decoration: InputDecoration(
                                    hintText: value.map["user"]["factory_name"],
                                    icon: Icon(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                                elevation: 0, primary: primaryBackgroundColor),
                            onPressed: () {
                              updateProfile();
                            },
                            child: Text(
