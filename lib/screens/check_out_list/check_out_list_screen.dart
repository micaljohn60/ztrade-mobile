...
class _CheckOutScreenState extends State<CheckOutScreen> {
  ...
  Widget build(BuildContext context) {
    final instance = Provider.of<CheckOutProvider>(context);

    final street = instance.address.data.street;
    final state = instance.address.data.state;
    final city = instance.address.data.city;
    final postalCode = instance.address.data.postalCode;
    final phoneNumber = instance.address.data.phone;
    final country = instance.address.data.country;
                                                    ...
                                                    Container(
                                                      ...
                                                      child: TextFormField(
                                                        validator: (text) {
                                                          ...
                                                          if (text.length < 6) {
                                                            return "It should be at least 6 characters";
                                                          }
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(phoneNumber,
                                    style: appStyle(
                                        14, FontWeight.w500, primaryTextColor)),
                              ],
                            ),
                          ),
                          const SizedBox(height: 8),
