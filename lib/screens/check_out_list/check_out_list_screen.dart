        ...
        children: [
          Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Consumer<CheckOutProvider>(
                          builder: (context, notifier, child) {
                            final street = notifier.address.data.street;
                            final state = notifier.address.data.state;
                            final city = notifier.address.data.city;
                            final postalCode = notifier.address.data.postalCode;
                            final country = notifier.address.data.country;
                            return SizedBox(
                              ...
                              child: Text(
                                ...
                                style: appStyle(
                                    13, FontWeight.w500, primaryTextColor),
              ...
              Consumer<CheckOutProvider>(
                builder: (_, notifier, __) {
                  final phoneNumber = notifier.address.data.phone;
                  return Padding(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 12.0,
                    ),
