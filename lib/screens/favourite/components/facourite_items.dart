...
class FavouriteItems extends StatelessWidget {
  ...
  String userID;
  FavouriteItems({Key key, this.products, this.userID}) : super(key: key);
            ...
            onTap: () {
              pushNewScreen(context,
                  screen: ProductDetail(
                    ...
                    itemDescription: products[index]["product"]
                        ["item_description"],
                        ...
                        children: [
                          ProductImage(
                            ...
                            imgUrl: ZtradeAPI.productImageUrl +
                                products[index]["product"]["product_image"][0]
                                        ["thumbnails"]
                                    .replaceAll('"', ''),
                          ),
                          Column(
                              ...
                              Padding(
                                ...
                                child: PriceTag(
                                    price: calculatePrice(
                                        ...
                                        products[index]["product"]["percentage"]
                                            ["percentage"])),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                          ...
                          Column(
                            children: [
                              HeartForFavourite(
                                userId: userID,
                                productId:
                                    products[index]["product"]["id"].toString(),
                                wishLists: [],
                                isWishList: true,
                              )
                            ],
